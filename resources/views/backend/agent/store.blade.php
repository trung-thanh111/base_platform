                            ...
                            <div class="col-lg-4">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="zalo"
                                        value="{{ old('zalo', $record->zalo ?? '') }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row mb15">
                                ...
                                <div class="form-row">
                                    <div class="uk-flex uk-flex-middle">
                                        <input id="is_primary" type="checkbox" name="is_primary" value="1"
                                            ...
                                            class="mr10" style="width: 20px; height: 20px;">
                                        <label for="is_primary" class="control-label no-margins cursor-pointer">Nhân
                                            viên chính (Hotline)</label>
                                    </div>
                                </div>
                            </div>
                        </div>
