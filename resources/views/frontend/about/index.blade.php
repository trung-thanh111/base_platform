                        ...
                        <div class="uk-grid uk-grid-medium" data-reveal-group>
                            <div class="uk-width-large-1-6 uk-width-medium-1-3" data-reveal="up">
                                <div class="homely-stat">
                                    ...
                                    <div class="homely-stat-value-drak" data-counter="{{ $property->area_sqm ?? '1665' }}"
                                        data-suffix=" m²">
                            ...
                            <div class="uk-width-large-1-6 uk-width-medium-1-3" data-reveal="up">
                                <div class="homely-stat">
                                    ...
                                    <div class="homely-stat-value-drak" data-counter="{{ $property->bedrooms ?? '5' }}"
                                        data-suffix=" PN">
                            ...
                            <div class="uk-width-large-1-6 uk-width-medium-1-3" data-reveal="up">
                                <div class="homely-stat">
                                    ...
                                    <div class="homely-stat-value-drak" data-counter="{{ $property->bathrooms ?? '5' }}"
                                        data-suffix=" PT">
                            ...
                            <div class="uk-width-large-1-6 uk-width-medium-1-3" data-reveal="up">
                                <div class="homely-stat">
                                    ...
                                    <div class="homely-stat-value-drak"
                                        data-counter="{{ $property->parking_spots ?? '5' }}" data-suffix=" Xe">
                            ...
                            <div class="uk-width-large-1-6 uk-width-medium-1-3" data-reveal="up">
                                <div class="homely-stat">
                                    ...
                                    <div class="homely-stat-value-drak" data-counter="{{ $property->price ?? '5' }}"
                            ...
                            <div class="uk-width-large-1-6 uk-width-medium-1-3" data-reveal="up">
                                <div class="homely-stat">
                                    <img src="{{ asset('frontend/resources/img/homely/svg/calendar.svg') }}"
                                        alt="Năm xây dựng">
                                    <div class="homely-stat-value-drak" data-counter="{{ $property->year_built ?? '5' }}"
                                        data-suffix="">
