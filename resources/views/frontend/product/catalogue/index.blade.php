                            ...
                            <div class="filter-block filter-search uk-margin-bottom">
                                ...
                                <div class="uk-form-icon">
                                    ...
                                    <input type="text" class="uk-form-small uk-width-1-1"
                                        placeholder="Nhập tên rượu vang...">
                                </div>
                            </div>
                    ...
                    <div class="uk-width-large-3-4">
                        <div class="prd-catalogue">
                            ...
                            <div class="product-list">
                                @if (!is_null($products))
                                    <ul
                                        class="uk-list uk-clearfix uk-grid uk-grid-small uk-grid-width-1-2 uk-grid-width-small-1-2 uk-grid-width-medium-1-2 uk-grid-width-large-1-4">
