...
@section('content')
    ...
    <div class="homely-page">
        ...
        <section class="homely-video-tour">
            <div class="homely-video-bg"
                style="background-image: url('{{ $property->image ?? asset('frontend/resources/img/homely/slider/1.webp') }}');">
            </div>
            <div class="homely-video-overlay"></div>
            <div class="play-btn-wrapper">
                <a href="{{ $property->video_tour_url ?? 'https://www.youtube.com' }}" class="play-btn" data-fancybox>
            ...
            <div class="uk-container uk-container-center">
                <div class="uk-grid uk-grid-large">
                    ...
                    <div class="uk-width-large-4-10">
                        ...
                        <h2 class="homely-section-title" data-reveal="up">Sơ đồ căn hộ</h2>
                                    ...
                                    <div class="swiper-slide" style="width:auto;">
                                        <div class="homely-gallery-item">
                                            <a href="{{ $img }}" data-fancybox="gallery"
                                                data-caption="{{ $gallery->name ?? 'Bộ Sưu Tập ' . $imgIndex }}">
                                                <img src="{{ $img }}"
                                                    alt="{{ $gallery->name ?? 'Bộ Sưu Tập ' . $imgIndex }}">
                                            </a>
                                            <div class="item-overlay pointer-events-none">
                                                <h4>{{ $gallery->name ?? 'Bộ Sưu Tập ' . $imgIndex }}</h4>
                                            </div>
                                        </div>
                                    </div>
                                    @php $imgIndex++; @endphp
